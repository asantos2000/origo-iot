...
static const struct lib_descr {
  ...
  // "demo_bundle". deps: [ "adc" "atca" "aws" "bt-service-config" "bt-service-debug" "ca-bundle" "dash" "dht" "dns-sd" "esp32-touchpad" "ethernet" "gcp" "http-server" "i2c" "ota-http-client" "ota-http-server" "ota-shadow" "pppos" "pwm" "rpc-gatts" "rpc-loopback" "rpc-mqtt" "rpc-service-atca" "rpc-service-config" "rpc-service-fs" "rpc-service-gpio" "rpc-service-i2c" "rpc-service-ota" "rpc-service-wifi" "rpc-uart" "shadow" "sntp" "spi" "vfs-dev-spi-flash" "wifi" ]
  {
    .title = "demo_bundle",
