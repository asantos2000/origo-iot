...
const struct mgos_conf_entry mgos_config_schema_[217] = {
  ...
  {.type = CONF_TYPE_OBJECT, .key = "sys", .num_desc = 14},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "eth", .num_desc = 7},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "rpc", .num_desc = 25},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "pppos", .num_desc = 11},
